...
def get_store_policies() -> Dict[str, str]:
    """Returns store policies including return policy, shipping, payment options, and FAQs."""
    return {
        "return_policy": "Products can be returned within 30 days of purchase in their original condition with proof of purchase.",
        "shipping": "Standard shipping takes 3-5 business days. Express shipping (1-2 days) is available at checkout.",
        "payment": "We accept all major credit/debit cards, PayPal, and bank transfers.",
        "cancellation": "Orders can be cancelled within 24 hours of placement if not yet shipped. Contact support immediately.",
        "support_hours": "Customer support is available Monday to Friday, 9AM–6PM.",
        "damaged_items": "For damaged or incorrect items, contact support within 7 days of delivery with photos for a full replacement or refund.",
        "tracking": "Order tracking information is sent to your email once the order is shipped.",
    }
